...
class NDN(nn.Module):
    ...
    def eval_models(
        ...
        if isinstance(data, dict): 
            ...
            assert data.block_sample == self.block_sample, "Dataset block_sample (%s) does not match model block_sample (%s) setting." % (str(data.block_sample), str(self.block_sample))
